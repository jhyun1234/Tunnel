...
최종 갱신 2026-09-15 (9차). 이 문서 하나만 읽어도 이어서 작업할 수 있어야 한다.
...
1. 마일스톤 2 재판정 (4절)
2. 다음 마일스톤 — 제안서로 하나씩. 순서는 설계서 v2 Step 7: ②b 눈·빛·추격·잡기 → ②c 체력·스턴·철수 → ③ 갱도 조립기(조각 23종) + 감독·NavMesh·배움 카드 → ④ 정비 → ⑤ 나머지 소리
...
M3 재판정(09-15): 1. 회갈색 캡슐 잘 보인다 ✓ 2. 5.0 m/s 온다로 읽힌다 ✓ → **M3 통과**. 다음은 ②b 제안서(눈·빛·추격·잡기).
