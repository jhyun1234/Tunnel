...
최종 갱신 2026-09-15 (13차). 이 문서 하나만 읽어도 이어서 작업할 수 있어야 한다.
...
1. 마일스톤 2 재판정 (4절)
2. 다음 마일스톤 — 제안서로 하나씩. 순서는 설계서 v2 Step 7(교차 검토 반영): ②c 체력·스턴·철수(캡슐판: 3대 철수·철수 중 무적·램프 원뿔 안 8~14 m 벽 타기·90 s 재등장) → ③ 갱도 조립기(조각 23종) + 감독·NavMesh·배움 카드 → ④ 정비 → ⑤ 나머지 소리
